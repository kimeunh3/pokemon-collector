...
function PokemonBookCard({ name, selectType1, selectType2, searchName, num }) {
  ...
  const type1List = {
    // normal
    '20': [ 16, 17, 18, 19, 20, 21, 22, 39, 40, 52, 53, 83, 84, 85, 108, 113, 115, 128, 132, 133, 137, 143 ],
    // fire
    '30': [ 4, 5, 6, 37, 38, 58, 59, 77, 78, 126, 136, 146 ],
    // water
    '40': [ 7, 8, 9, 54, 55, 60, 61, 62, 72, 73, 79, 80, 86, 87, 90, 91, 98, 99, 116, 117, 118, 119, 120, 121, 129, 130, 131, 134 ],
    // grass
  ...
  const type2List = {
    ...
    // flying
    '110': [ 6, 12, 16, 17, 18, 21, 22, 41, 42, 83, 84, 85, 123, 130, 142, 144, 145, 146, 149 ],
    // psychic
  ...
  const typeColorList = { '10': '#fff', '20': '#A8A878', '30': '#F08030', '40': '#6890F0', '50': '#78C850', '60': '#F8D030', '70': '#98D8D8', '80': '#C03028', '90': '#A040A0', '100': '#E0C068', '110': '#A890F0', '120': '#F85888', '130': '#A8B820', '140': '#B8A038', '150': '#705898', '160': '#7038F8', '170': '#B8B8D0', '180': '#EE99AC' }
  ...
  return (
    <Card onClick={() => navigate('/pokemonDetail')} style={ type2 === '10' ? { 
