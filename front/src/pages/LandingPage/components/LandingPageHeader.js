...
import {
  Toolbar, IconButton, styled, Button, Grid, useMediaQuery,
} from '@material-ui/core';
import MuiAppBar from '@material-ui/core/AppBar';

function LandingPageHeader({ open, setOpen, isLogin, handleDialogOpen, logout }) {
    ...
    return (
        ...
        >
            ...
            {isLogin ? (
                <Grid container style={isMobile ? { display: 'none', marginBottom: '80px', textAlign: 'center' } : { marginBottom: '80px', textAlign: 'center' }}>
                    <Grid item xs={2}>
